...
public class OrderController {
	...
	public ResponseEntity<List<Order>> getOrder(@PathVariable String mobileNo ){
		return ResponseEntity.status(HttpStatus.FOUND).body(orderService.getOrderByMobileNo(mobileNo));
	}
}
